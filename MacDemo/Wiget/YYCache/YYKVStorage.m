...
static NSApplication *_YYSharedApplication() {
...
#pragma clang diagnostic ignored "-Wundeclared-selector"
    return isAppExtension ? nil : [NSApplication performSelector:@selector(sharedApplication)];
...
//- (void)dealloc {
//    NSBackgroundTaskIdentifier taskID = [_YYSharedApplication() beginBackgroundTaskWithExpirationHandler:^{}];
//    [self _dbClose];
